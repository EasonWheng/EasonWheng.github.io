...
(function () {
  ...
  function installPfd() {
    ...
    pfd.innerHTML = [
      ...
      '<svg class="pfd-adi" viewBox="0 0 200 200" aria-hidden="true"><defs><clipPath id="pfd-adi-clip"><polygon points="34,24 166,24 190,49 190,151 166,176 34,176 10,151 10,49"/></clipPath></defs><g clip-path="url(#pfd-adi-clip)"><g id="adiWorld" class="adi-world"><g id="adiRoll" class="adi-roll"><rect x="-120" y="-160" width="440" height="260" fill="#20a9db"/><rect x="-120" y="100" width="440" height="260" fill="#703224"/><g stroke="#fff" stroke-width="1.4" fill="#fff" font-size="9" text-anchor="middle"><path d="M67 40h66M76 55h48M58 70h84M76 85h48M76 115h48M58 130h84M76 145h48M67 160h66"/><text x="54" y="43">20</text><text x="146" y="43">20</text><text x="67" y="73">10</text><text x="133" y="73">10</text><text x="67" y="133">10</text><text x="133" y="133">10</text><text x="54" y="163">20</text><text x="146" y="163">20</text></g><line x1="-120" y1="100" x2="320" y2="100" stroke="#fff" stroke-width="2"/></g></g></g><path d="M100 17 94 28h12z" fill="#fff"/><g stroke="#ff0" stroke-width="1.8" fill="#000" stroke-linejoin="round"><path d="M100 97 65 91v7h28v10l7-11z"/><path d="m100 97 35-6v7h-28v10l-7-11z"/></g><g class="fd" id="pfdFd" stroke="#ff94ff" stroke-width="2"><path d="M100 56v29"/><path d="M69 101h62"/></g><polygon points="34,24 166,24 190,49 190,151 166,176 34,176 10,151 10,49" fill="none" stroke="rgba(255,255,255,.35)" stroke-width="1.5"/></svg>',
